...
namespace ads1100 {
    ...
    const uint8_t DEFAULT_CONFIG   =  12;      // B00001100 (16-BIT, 8 SPS, GAIN x1, CONTINUOUS)
    ...
    enum sample_rate_t {
        ...
        SPS_8   = 0x0C,        // 12 - B00001100 (Default)
        SPS_16   = 0x08,       //  8 - B00001000
        SPS_32   = 0x04,       //  4 - B00000100
        SPS_128  = 0x00        //  0 - B00000000
    };
    ...
    enum min_code_t {
        MIN_CODE_128 = 0x01,   //  1 - Minimal Data Value for 128_SPS / -2048  (12-BIT)
        MIN_CODE_32  = 0x04,   //  4 - Minimal Data Value for 32_SPS  / -2048  (14-BIT)
        MIN_CODE_16  = 0x08,   //  8 - Minimal Data Value for 16_SPS  / -2048  (15-BIT)
        MIN_CODE_8  = 0x10     // 16 - Minimal Data Value for 8_SPS  / -2048  (16-BIT) (Default)
    };
